...
const Cart = () => {
  ...
  // Get cart items and update cartArray
  const getCart = () => {
    let tempArray = [];
    if (cartItems) {
  ...
  const placeOrder = async () => {
    try {
      if(!user)toast.success("Please login to Continue");
      ...
      <div className="flex-1 max-w-4xl">
        ...
        >
          <img
            ...
            alt="arrow"
            className="group-hover:transition-x-1 transition"
          />
          Continue Shopping
        </button>
      </div>
      ...
      <div className="max-w-90 w-full bg-gray-100 p-5 max-md:mt-16">
        ...
        <div className="mb-6">
          ...
          <div className="relative flex justify-between items-start mt-2">
            ...
            {showAddress && (
              <div className="absolute top-12 left-0 py-1 bg-white border border-gray-300 text-sm w-full z-10 shadow-md">
